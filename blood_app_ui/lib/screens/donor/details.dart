...
class BloodDonorDetails extends StatelessWidget {
  const BloodDonorDetails({Key? key}) : super(key: key);
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                    border: Border(
                      ...
                      right: BorderSide(style: BorderStyle.solid, width: 1, color: Color(0xFFD9D9D9),),
                    )
                ),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
